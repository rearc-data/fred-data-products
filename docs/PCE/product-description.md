## Personal Consumption Expenditures (PCE) | FRED
...
This dataset contains a historical time-series data of the Personal Consumption Expenditures (PCE) starting from `1959-01-01`. 

The values within the data field labeled `PCE` represent the personal expenditure at the time of the corresponding `DATE` field. The unit of data column is Billions of Dollars and the values are based on seasonally adjusted annual rate. BEA account code for this dataset is `DPCERC`.
...
- Dataset Page: [U.S. Bureau of Economic Analysis, Personal Consumption Expenditures (PCE)](https://fred.stlouisfed.org/series/PCE)
