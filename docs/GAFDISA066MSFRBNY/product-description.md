##  Future General Business Conditions; Diffusion Index for New York (GAFDISA066MSFRBNY)	 | FRED

The source code outlining how this product gathers, transforms, revises and publishes its datasets is available at [https://github.com/rearc-data/fred-data-products](https://github.com/rearc-data/fred-data-products).

### Main Overview
The dataset file included with this product is provided in CSV format. The included dataset contains the following columns: 
`DATE`, `GAFDISA066MSFRBNY`
...
- Dataset Page: [ Future General Business Conditions; Diffusion Index for New York (GAFDISA066MSFRBNY)	 | FRED](https://fred.stlouisfed.org/series/GAFDISA066MSFRBNY)
