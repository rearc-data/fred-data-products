...
This dataset contains a historical time-series data of the 10-Year Treasury Constant Maturity Rate starting from `1962-01-02`. 
 
The values within the data field labeled `DGS10` represent the constant maturity rate in `Percent` at the time of the corresponding `DATE` field. Values are not seasonally adjusted.
...
- Dataset Page: [10-Year Treasury Constant Maturity Rate (DGS10) | FRED](https://fred.stlouisfed.org/series/DGS10)
