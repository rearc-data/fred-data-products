## 1-Year Treasury Constant Maturity Rate (DGS1) | FRED
...
This dataset contains a historical time-series data of 1-Year Treasury Constant Maturity Rate starting from `1962-01-02`. 
 
The values within the data field labeled `DGS1` represent constant maturity index in `Percent` at the time of the corresponding `DATE` field. Values are not seasonally adjusted.
...
- Dataset Page: [1-Year Treasury Constant Maturity Rate (DGS1) | FRED](https://fred.stlouisfed.org/series/DGS1)
