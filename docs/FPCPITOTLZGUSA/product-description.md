...
This dataset contains a historical time-series data of Inflation, consumer prices for the United States (FPCPITOTLZGUSA)	starting from `1960-01-01`. 
 
The values within the data field labeled `FPCPITOTLZGUSA` represents inflation in the US as the consumer price index in `Percent` at the time of the corresponding `DATE` field. Values are not seasonally adjusted.
...
- Dataset Page: [ Inflation, consumer prices for the United States (FPCPITOTLZGUSA)	 | FRED](https://fred.stlouisfed.org/series/FPCPITOTLZGUSA)
